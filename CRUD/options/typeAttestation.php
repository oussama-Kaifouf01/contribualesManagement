    ...
    <div class="card-body">
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            <div class="datatable-top">
                <div id="formToAddTypeCourier" class="form-group">
                    <div>
                        <label for="typeName" class="form-label">Type De Courier:</label><br>
                        <input type="text" id="typeName" name="typeName" class="form-control form-control-sm"><br>
                        <button id="submitAddTypeCourier" class="btn btn-primary btn-sm">Ajouter</button>
                    </div>
                </div>
                <script>
