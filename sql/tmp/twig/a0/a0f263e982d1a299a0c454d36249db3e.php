...
class __TwigTemplate_7bee9f424da8440c24128ba73ec101ed extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\MAMP\\htdocs\\Yassine\\sql\\templates\\database\\export\\index.twig");
    }
}
