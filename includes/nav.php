<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #a3e4eb">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html"> <img width="200px" src="/assets/img/MEF_MOROCCO.png" alt=""
            srcset="">
    </a>
    <!-- Sidebar Toggle-->
